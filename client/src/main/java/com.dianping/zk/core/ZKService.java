...
import com.dianping.lion.LionUtil;
...
public class ZKService {
	...
	private final String DQC_NAMESPACE = "dqc_ns";
	private final String DQC_ZK_CONNECTION_URL_LABEL = "dqc.zk.connection.url";
	...
	public synchronized CuratorFramework getZookeeper() {
		if (zk == null) {
			...
			RetryPolicy retryPolicy = new ExponentialBackoffRetry(SLEEP_BETWEEN_TRIES, RETRY_COUNT);
